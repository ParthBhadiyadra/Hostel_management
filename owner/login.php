...
if(isset($_POST['log']))
{
    ...
    $str="select * from owner where email='".$email."' and password='".$pass."' and email_status=1";
    $res=mysqli_query($con,$str) or die("error");
...
<body>
  ...
  <p class="text-center" style="font-size: 20px;"> <i class="fas fa-user-secret text-danger"></i> <span class="badge badge-pill badge-danger">Owner
      Login </span> &nbsp;<span class="links"><i class="fa fa-graduation-cap"></i> <a href="../student/login.php" class=" badge badge-pill badge-primary">Student Login</a> </span>
  </p>
